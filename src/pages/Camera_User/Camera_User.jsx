...
//         newWindow.document.getElementById("goToNextButton");
...
//     } else {
//       alert(
//         "팝업 창이 차단되었습니다. 브라우저 설정에서 팝업 차단을 해제해주세요."
//       );
//     }
//   };

//   const rotateLeft = () => {
//     setRotationAngle((prevAngle) => prevAngle - 15);
//   };
...
//       const newX = Math.max(
//         lineStartX + circleWidth / 2,
//         circlePosition.x - stepSize
//       );
...
//             <label className="camera-button-style">
//               {" "}
//               {/*얘는 왜 버튼 디자인이 다른지 모르겠음...*/}
...
const Camera_User = () => {
  return (
    <div className="product-number-body">
      <div className="product-number-block">
        <div className="product-number-block-bold">가방</div>
        <span>1201</span>
        <span>1202</span>
        <span>1203</span>
        <span>1204</span>
      ...
      <div className="product-number-block">
        <div className="product-number-block-bold">귀걸이</div>
        <span>2201</span>
        <span>2202</span>
        <span>2203</span>
        <span>2204</span>
      ...
      <div className="product-number-block">
        <div className="product-number-block-bold" n>
          모자
        </div>
        <span>3201</span>
        <span>3002</span>
      ...
      <div className="product-number-block">
        <div className="product-number-block-bold">반지</div>
        <span>4201</span>
      </div>
      <div className="product-number-block">
        <div className="product-number-block-bold">시계</div>
        <span>6001</span>
        <span>6002</span>
        <span>6003</span>
        <span>6004</span>
      ...
      <div className="product-number-block">
        <divn className="product-number-block-bold">썬글라스</divn>
        <span>7001</span>
        <span>7002</span>
        <span>7003</span>
      </div>
      <div className="product-number-block">
        <div className="product-number-block-bold">팔찌</div>
        <span>8201</span>
      </div>
      <div className="SizedBox"></div>
      <div className="SizedBox"></div>
